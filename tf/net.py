...
class Net:
    ...
    def fill_layer_old(self, layer, weights):
        """Normalize and populate 16bit layer in protobuf"""
    ...
    def get_weights_v2(self, names):
        ...
        for tf_name in names:
            ...
            if 'renorm_mean:0' in name:
                # Populate renorm statistics with moving means.
                name = name.replace('renorm_mean', 'moving_mean')
            if 'renorm_variance:0' in name:
                # Populate renorm statistics with moving means.
                name = name.replace('renorm_variance', 'moving_variance')
